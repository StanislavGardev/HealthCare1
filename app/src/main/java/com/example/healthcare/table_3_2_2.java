...
public class table_3_2_2 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L3_4;
    Spanned Links3_3;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_3_2_2.this, table_3_3.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_3_2_2.this, table_3_2_1.class);
        startActivity(intent);
        this.finish();
