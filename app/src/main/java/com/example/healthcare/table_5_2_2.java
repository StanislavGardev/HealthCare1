...
public class table_5_2_2 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_5_2_2.this, table_5_3.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_5_2_2.this, table_5_2_1.class);
        startActivity(intent);
        this.finish();
