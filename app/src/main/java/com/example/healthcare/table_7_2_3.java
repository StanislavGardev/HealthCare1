...
public class table_7_2_3 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_7_2_3.this, table_7_3.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_7_2_3.this, table_7_2_2.class);
        startActivity(intent);
        this.finish();
