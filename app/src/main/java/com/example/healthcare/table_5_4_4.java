...
public class table_5_4_4 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L5_50;
    Spanned Link_5_50;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_4.this, table_6_1.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_4.this, table_5_4_3_4.class);
        startActivity(intent);
        this.finish();
