...
public class table_6_4_5_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L6_52;
    Spanned Link_6_52;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_5_1.this, table_6_4_5_2.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_5_1.this, table_6_4_4.class);
        startActivity(intent);
        this.finish();
