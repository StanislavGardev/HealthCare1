...
public class table_6_4_5_3 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_5_3.this, table_6_4_6.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_5_3.this, table_6_4_5_2.class);
        startActivity(intent);
        this.finish();
