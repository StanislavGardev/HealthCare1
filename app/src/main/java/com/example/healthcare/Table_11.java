...
public class Table_11 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L11;
    Spanned Link_11;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(Table_11.this, table_13.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(Table_11.this, table_10_2.class);
        startActivity(intent);
        this.finish();
