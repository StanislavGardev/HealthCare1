...
public class table_5_4_3_2 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    Spanned Link_5_46;
    TextView text_5_4_6;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_3_2.this, table_5_4_3_3.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_3_2.this, table_5_4_3_1.class);
        startActivity(intent);
        this.finish();
