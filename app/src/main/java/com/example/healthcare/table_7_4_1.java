...
public class table_7_4_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_7_4_1.this, table_7_4_2.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_7_4_1.this, table_7_4.class);
        startActivity(intent);
        this.finish();
