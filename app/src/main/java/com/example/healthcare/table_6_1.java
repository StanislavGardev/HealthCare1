...
public class table_6_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L6_4;
    Spanned Link_6_4;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_1.this, table_6_2.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_1.this, table_5_4_4.class);
        startActivity(intent);
        this.finish();
