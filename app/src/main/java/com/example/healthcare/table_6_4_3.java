...
public class table_6_4_3 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L6_49;
    Spanned Link_6_49;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_3.this, table_6_4_4.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_3.this, table6_4_2.class);
        startActivity(intent);
        this.finish();
