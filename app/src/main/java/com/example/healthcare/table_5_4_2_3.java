...
public class table_5_4_2_3 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_2_3.this, table_5_4_3_1.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_2_3.this, table_5_4_2_2.class);
        startActivity(intent);
        this.finish();
