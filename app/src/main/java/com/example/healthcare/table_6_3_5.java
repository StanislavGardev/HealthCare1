...
public class table_6_3_5 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_3_5.this, table_6_4_1.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_3_5.this, table_6_3_4.class);
        startActivity(intent);
        this.finish();
