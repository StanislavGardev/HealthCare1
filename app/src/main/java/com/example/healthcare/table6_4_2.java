...
public class table6_4_2 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table6_4_2.this, table_6_4_3.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table6_4_2.this, table_6_4_1.class);
        startActivity(intent);
        this.finish();
