...
public class table_8_2 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_8_2.this, table_8_3.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_8_2.this, table_8_1.class);
        startActivity(intent);
        this.finish();
