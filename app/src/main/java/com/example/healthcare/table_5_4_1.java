...
public class table_5_4_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L5_30;
    Spanned Link_5_30;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_1.this, table_5_4_2_1.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_5_4_1.this, table_5_3.class);
        startActivity(intent);
        this.finish();
