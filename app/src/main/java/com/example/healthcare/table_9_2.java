...
public class table_9_2 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_9_2.this, table_9_3.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_9_2.this, table_9_1.class);
        startActivity(intent);
        this.finish();
