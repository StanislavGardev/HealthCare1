...
public class table_13 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L13;
    Spanned Link_13;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_13.this, table_4_1.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_13.this, Table_11.class);
        startActivity(intent);
        this.finish();
