...
public class table_6_3_4 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_3_4.this, table_6_3_5.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_3_4.this, table_6_3_3_2.class);
        startActivity(intent);
        this.finish();
