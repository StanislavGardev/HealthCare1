...
public class table_6_3_3_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_3_3_1.this, table_6_3_3_2.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_3_3_1.this, table_6_3_2.class);
        startActivity(intent);
        this.finish();
