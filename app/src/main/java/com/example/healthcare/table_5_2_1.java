...
public class table_5_2_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L5_15;
    Spanned Link_5_15;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_5_2_1.this, table_5_2_2.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_5_2_1.this, table_5_2.class);
        startActivity(intent);
        this.finish();
