...
public class table_5_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_5_1.this, table_5_2.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_5_1.this, table_4_1.class);
        startActivity(intent);
        this.finish();
