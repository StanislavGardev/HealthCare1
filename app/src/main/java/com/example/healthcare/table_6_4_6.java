...
public class table_6_4_6 extends AppCompatActivity implements GestureDetector.OnGestureListener {
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_6.this, table_6_5.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_6_4_6.this, table_6_4_5_3.class);
        startActivity(intent);
        this.finish();
