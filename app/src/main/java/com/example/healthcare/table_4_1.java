...
public class table_4_1 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    TextView L4_2, L4_3;
...
//    }
    ...
    private void onSwipeLeft() {
        ...
        Intent intent;
        intent = new Intent(table_4_1.this, table_5_1.class);
    ...
    private void onSwipeRight() {
        ...
        Intent intent;
        intent = new Intent(table_4_1.this, table_3_3.class);
        startActivity(intent);
        this.finish();
